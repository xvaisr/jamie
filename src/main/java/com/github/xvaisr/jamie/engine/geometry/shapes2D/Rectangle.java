...
import com.github.xvaisr.jamie.engine.geometry.basic.Dimension;
 ...
 * @author Roman Vais
 */
public class Rectangle implements Serializable, Cloneable, Shape {
	...
	public boolean contains(Rectangle r) {
		return this.contains(r.getBottomLeftCorner()) && this.contains(r.getBottomLeftCorner());
	}
