...
package com.github.xvaisr.jamie.engine.geometry.basic;

import java.io.Serializable;

/**
 * Class represents point in a three-dimensional space of Cartesian coordinate
 * system.
 * Class has methods that allow for using it's instances as two-dimensional or
 * three-dimensional points. By extending this class, you can use protected
 * final methods
...
public class Point implements Cloneable, Serializable, Comparable<Point> {
	...
	/**
	 * Enumeration of values which can be used as key for comparison/sort
	 * process of Points
	 */
	...
	/**
	 * Creates immutable instance of Point suitable for a three-dimensional
	 * space
	 * represented by Cartesian coordinate system.
	 * Default constructor without parameters creates point with coordinates
	 * equal
	 ...
	 *
	 * @param x
	 *            - value of coordinates on X axis
	 * @param y
	 *            - value of coordinates on Y axis
	 */
	 ...
	 * space
	 * represented by Cartesian coordinate system.
	 * Constructor with X, Y and Z parameters creates point with coordinates
	 * equal
	 ...
	 *            - value of coordinates on Y axis
	 * @param z
	 *            - value of coordinates on Z axis
	 */
	 ...
	 * 
	 * @param key
	 *            - one of Point.SortBy.x Point.SortBy.y Point.SortBy.z values
	 ...
	 * 
	 * @param dx
	 *            - distance on X axis to move this point
	 * @param dy
	 *            - distance on Y axis to move this point
	 */
	 ...
	 *            - distance on Y axis to move this point
	 * @param dz
	 *            - distance on Z axis to move this point
	 */
	 ...
	 * 
	 * @param x
	 *            - new coordinate value on X axis
	 * @param y
	 *            - new coordinate value on Y axis
	 */
	 ...
	 *            - new coordinate value on Y axis
	 * @param z
	 *            - new coordinate value on Z axis
	 */
	 ...
	 * 
	 * @param dx
	 *            - distance on X axis to move new point
	 * @param dy
	 *            - distance on Y axis to move new point
	 ...
	 *            - distance on Y axis to move new point
	 * @param dz
	 *            - distance on Z axis to move new point
	 * @return copy of this point shifted by given distances
	 */
